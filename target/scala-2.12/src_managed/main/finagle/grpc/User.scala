...
final case class User(
    ...
    def withAge(__v: _root_.scala.Int): User = copy(age = __v)
    ...
    def companion = finagle.grpc.User
}

object User extends scalapb.GeneratedMessageCompanion[finagle.grpc.User] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[finagle.grpc.User] = this
  def merge(`_message__`: finagle.grpc.User, `_input__`: _root_.com.google.protobuf.CodedInputStream): finagle.grpc.User = {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[finagle.grpc.User] = _root_.scalapb.descriptors.Reads{
  ...
  lazy val defaultInstance = finagle.grpc.User(
    name = "",
    age = 0
  )
  implicit class UserLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, finagle.grpc.User]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, finagle.grpc.User](_l) {
  ...
  ): _root_.finagle.grpc.User = _root_.finagle.grpc.User(
    name,
    age
  )
}
